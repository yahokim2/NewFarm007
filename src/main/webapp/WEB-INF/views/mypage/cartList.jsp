  ...
  <article style="margin-bottom: 20px">
    ...
    <c:otherwise>
      <table id="cartList">
        ...
        <tr>      
          <td>
            <a href="product_detail?pdseq=${cartVO.pdseq}">
              <h3> ${cartVO.pname} </h3>              
            </a>    
          </td>
          ...
          <td> <input type="checkbox" name="ctseq" id="ctseq" value= "${cartVO.ctseq}"> 
          </td>
        </tr>
        </c:forEach>
    ...
    <div id="buttons" style="float: right">
      <input type="button" value="쇼핑 계속하기" class="joinup" onclick="location.href='index'">
      											<!-- cancel / joinup -->    
