  ...
  <tr>
    <td>
      <c:choose>
        ...
        <span style="font-weight: bold; color: blue">${orderVO.ordetailseq}</span>
        (<input type="checkbox" name="result" value="${orderVO.ordetailseq}"> 미처리)
        </c:when>
        <c:otherwise>
          <span style="font-weight: bold; color: red">${orderVO.ordetailseq}</span>
